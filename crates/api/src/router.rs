...
pub fn build_router(state: AppState) -> Router {
    ...
    if state.auth.is_some() {
        let api_v1 = Router::new()
            ...
            .route("/api/v1/projects/{project_id}/userstories", get(backlog::list_us))
            .route("/api/v1/projects/{project_id}/userstories", post(backlog::create_us))
            .route("/api/v1/projects/{project_id}/userstories/bulk", post(backlog::bulk_create_us))
            .route("/api/v1/projects/{project_id}/userstories/{id}", get(backlog::get_us))
            .route("/api/v1/projects/{project_id}/userstories/{id}", patch(backlog::update_us))
            .route("/api/v1/projects/{project_id}/userstories/{id}", delete(backlog::delete_us))
            .route("/api/v1/projects/{project_id}/userstories/{id}/move", post(backlog::move_us))
            // Backlog — tasks
            .route("/api/v1/projects/{project_id}/tasks", get(backlog::list_tasks))
            .route("/api/v1/projects/{project_id}/tasks", post(backlog::create_task))
            .route("/api/v1/projects/{project_id}/tasks/{id}", get(backlog::get_task))
            .route("/api/v1/projects/{project_id}/tasks/{id}", patch(backlog::update_task))
            .route("/api/v1/projects/{project_id}/tasks/{id}", delete(backlog::delete_task))
            // Backlog — issues
